...
slice1 = train.loc[
    (train.game_time == train.Total_Game_Session_Time) & (train.event_count == train.Total_Game_Session_Events),
...
type_slice = type_slice[type_slice.Assessment == 1]

type_slice = type_slice.rename(columns={'Order': 'Past_Game_Sessions'})
type_slice = type_slice.drop(['Game','Clip', 'Assessment','Activity'], axis = 1)


type_slice['Clip_Experience'] = type_slice['Past_Clips'] / type_slice['Past_Game_Sessions']
type_slice['Game_Experience'] = type_slice['Past_Games'] / type_slice['Past_Game_Sessions']
type_slice['Assessment_Experience'] = type_slice['Past_Assessments'] / type_slice['Past_Game_Sessions']
type_slice['Activity_Experience'] = type_slice['Past_Activities'] / type_slice['Past_Game_Sessions']

type_slice = type_slice.loc[:, ['installation_id', 'game_session', 'Clip_Experience', 'Game_Experience', 'Assessment_Experience', 'Activity_Experience']].drop_duplicates()